...
const main = async () => {
  ...
  const YourHecoContract = await deploy("YourHecoContract"); // <-- add in constructor args like line 19 vvvv
  ...
  */
  ...
  await tenderlyVerify(
    {contractName: "YourHecoContract",
     contractAddress: YourHecoContract.address
  })
  */
